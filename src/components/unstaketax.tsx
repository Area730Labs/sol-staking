...
import { claimPendingrewardsHandlerImpl } from "./pendingrewards";
...
export interface UnstakeTaxModalProps {
    staking: StakingContextType
  }
  
  export function UnstakeTaxModal(props: UnstakeTaxModalProps) {
  
    // toast.info('calc taxes ...')
  
    const { setModalVisible } = useModal();
    const ctx = useAppContext();
    const { stackedNfts, calculateIncomeWithTaxes, platform, pendingRewards, pretty, config, fromStakeReceipt } = props.staking;
